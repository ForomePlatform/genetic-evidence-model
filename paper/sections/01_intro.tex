...
require standardization: \emph{Relevance and Specificity}, that is,
...
\begin{itemize}
    ...
    \EvidenceAssertion), genetic specializations, a compact dimensional
    ...
    \item A structural alignment of the core classes with HL7 FHIR Evidence,
        ...
        SEPIO, IAO, and OBI; Supplementary Note~\ref*{supp:sec:supp-crosswalk} provides a partial
        term-level mapping.
...
the released artifacts (\Cref{sec:availability}), and concludes
(\Cref{sec:conclusion}).
