...
analysis as a matrix of ten evidence patterns and the standards, including
our model. For each pattern, the matrix indicates whether a standard
represents it natively, only by extension, or not at all. Of these
