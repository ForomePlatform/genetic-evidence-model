...
can do in isolation: the target of each parse is a structured,
source-anchored representation, and the quality of the parse depends
on the quality of that target language. We see the present
