...
% from the ICBO 2026 camera-ready template when available.
    ...
    \begin{abstract}
        ...
        evidence with three core classes, specialise it for genetics, align it structurally to FHIR Evidence with a
        SEPIO-anchored credibility decomposition, and attach a compact
        dimensional vocabulary whose conditional-activation
